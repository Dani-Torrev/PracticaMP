 ...
 * Descripción: Inicializa un jugador con los datos proporcionados
 * 
 * Precondiciones:
 *   - j debe ser un puntero válido a una estructura Jugador
 ...
 * 
 * Precondiciones:
 *   - j debe ser un puntero válido a una estructura Jugador inicializada
 ...
 * 
 * Precondiciones:
 *   - j debe ser un puntero válido a una estructura Jugador (puede estar inicializada o no)
 * 
 * Postcondiciones:
