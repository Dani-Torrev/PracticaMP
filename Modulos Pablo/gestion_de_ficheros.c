// Includes para entrada/salida, memoria, strings y header de gestión de ficheros
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "gestion_de_ficheros.h"

// Función para leer una línea de forma segura evitando desbordamientos
...
// Función para cargar los ficheros del juego (salas, puzles, conexiones)
...
// Función para guardar los ficheros del juego (aún no implementada)
